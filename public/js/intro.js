...
(function (root, factory) {
  ...
  function _introForElement(targetElm) {
    ...
    if(_addOverlayLayer.call(self, targetElm)) {
      ...
      var
      /*skipButton     = targetElm.querySelector('.introjs-skipbutton'),
          nextStepButton = targetElm.querySelector('.introjs-nextbutton');*/
        skipButton = targetElm.querySelector(".introjs-skipbutton") != null ? targetElm.querySelector(".introjs-skipbutton") : targetElm.querySelector(".introjs-donebutton"),
                nextStepButton = targetElm.querySelector('.introjs-nextbutton');
